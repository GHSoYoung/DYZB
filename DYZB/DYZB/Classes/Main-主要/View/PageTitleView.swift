...
class PageTitleView: UIView {
    ...
    // 滑块初始位置
    private var scrollLineStart :CGFloat = 0
...
//MARK:- 事件监听
extension PageTitleView{
    @objc func labelClick(tapGes:UITapGestureRecognizer){
        // 1.获取当前label
